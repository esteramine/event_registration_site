...
function EventCard() {
    return (
        <div className="bg-white rounded-md p-4 max-w-xs flex flex-col space-y-1 text-gray-700 shadow-md hover:shadow-2xl transition-all duration-150 ease-linear cursor-pointer">
            {/* Access Scope */}
