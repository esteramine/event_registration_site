...
function EventCard({ event: { title, description, eventCode, eventTime, organizer, createdAt, participantCount, restrictions } }) {
    return (
        <div className="bg-white rounded-md p-4 m-2 h-56 flex flex-col justify-between text-gray-700 shadow-md hover:shadow-2xl transition-all duration-150 ease-linear cursor-pointer">
